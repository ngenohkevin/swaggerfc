  ...
  return (
    <div className="bg-black text-white min-h-screen font-inter">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        {/* Tech Stack Info */}
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-4 sm:p-6 mb-8 sm:mb-12">
          <h3 className="font-semibold text-lg mb-3">Technology Stack</h3>
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <span className="bg-zinc-800 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm">Next.js 15 (Latest)</span>
            <span className="bg-zinc-800 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm">Tailwind CSS 4</span>
            <span className="bg-zinc-800 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm">shadcn/ui Components</span>
            <span className="bg-zinc-800 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm">Strapi CMS</span>
            <span className="bg-zinc-800 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm">Embla Carousel (Auto-scroll)</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {/* Design 1 */}
          <Link href="/design-1" className="group block h-full">
            <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all hover:shadow-2xl hover:shadow-yellow-500/10 h-full flex flex-col">
              <div className="h-48 sm:h-56 lg:h-64 bg-gradient-to-br from-zinc-900 to-black relative overflow-hidden flex-shrink-0">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <span className="text-yellow-400 text-xs uppercase tracking-wider">Preview</span>
                </div>
              </div>
              <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-2">
                  <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-1 rounded">DESIGN 1</span>
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 group-hover:text-yellow-400 transition-colors">Classic Club</h3>
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Black Theme</span>
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Yellow Accents</span>
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Bold Typography</span>
                </div>
              </div>
            </div>
          </Link>
          ...
          {/* Design 2 */}
          <Link href="/design-2" className="group block h-full">
            <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all hover:shadow-2xl hover:shadow-yellow-500/10 h-full flex flex-col">
              <div className="h-48 sm:h-56 lg:h-64 bg-gradient-to-br from-zinc-900 to-black relative overflow-hidden flex-shrink-0">
              ...
              <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-1 rounded">DESIGN 2</span>
                  <span className="bg-yellow-500/30 text-yellow-300 text-xs px-2 py-1 rounded">RECOMMENDED</span>
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 group-hover:text-yellow-400 transition-colors">Modern Energy</h3>
                <p className="text-gray-400 text-sm mb-4 flex-grow">
                  Dynamic design with gradient accents, glassmorphism effects, and vibrant colors. Contemporary and engaging.
                </p>
                <div className="flex flex-wrap gap-2 mt-auto">
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Gradients</span>
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Glass Effects</span>
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Modern UI</span>
                </div>
              </div>
            </div>
          </Link>
          ...
          {/* Design 3 */}
          <Link href="/design-3" className="group block h-full">
            <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all hover:shadow-2xl hover:shadow-yellow-500/10 h-full flex flex-col">
              ...
              <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-2">
                  <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-1 rounded">DESIGN 3</span>
                </div>
                <h3 className="text-lg sm:text-xl font-bold mb-2 group-hover:text-yellow-400 transition-colors">Community Focus</h3>
                <p className="text-gray-400 text-sm mb-4 flex-grow">
                  Warm, welcoming design with light tones, organic shapes, and clean typography. Approachable and inviting.
                </p>
                <div className="flex flex-wrap gap-2 mt-auto">
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Light Theme</span>
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Warm Colors</span>
                  <span className="bg-zinc-800 text-xs px-2 py-1 rounded">Friendly Feel</span>
                </div>
              </div>
            </div>
          </Link>
        ...
        {/* Footer */}
        <div className="mt-10 sm:mt-12 text-center text-gray-500 text-sm">
