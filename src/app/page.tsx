        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#6b6560] dark:text-white/70 leading-relaxed text-sm sm:text-base">
          ...
          {/* Values - Below content */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12 sm:mt-16">
            <div className="bg-[#1a1f2e] dark:bg-[#0f1219] border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="w-12 h-12 bg-[#2d2a1f] border border-[#c9a227]/30 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-5 h-5 text-[#c9a227]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z"/>
                </svg>
              </div>
              <h4 className="font-dm-serif text-xl text-[#c9a227] mb-2">{aboutData?.value1Title || "Community"}</h4>
              <p className="text-white/60 leading-relaxed">{aboutData?.value1Description || "Collaboration with schools, parents and the community, creating a strong support system that allows young athletes to balance education and sports successfully."}</p>
            </div>
            <div className="bg-[#1a1f2e] dark:bg-[#0f1219] border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="w-12 h-12 bg-[#2d2a1f] border border-[#c9a227]/30 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-5 h-5 text-[#c9a227]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-dm-serif text-xl text-[#c9a227] mb-2">{aboutData?.value2Title || "Excellence"}</h4>
              <p className="text-white/60 leading-relaxed">{aboutData?.value2Description || "Emphasis on values such as respect, commitment, teamwork, and leadership, preparing our players also for life outside football."}</p>
            </div>
            <div className="bg-[#1a1f2e] dark:bg-[#0f1219] border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="w-12 h-12 bg-[#2d2a1f] border border-[#c9a227]/30 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-5 h-5 text-[#c9a227]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-dm-serif text-xl text-[#c9a227] mb-2">{aboutData?.value3Title || "Passion"}</h4>
              <p className="text-white/60 leading-relaxed">{aboutData?.value3Description || "To build champions with character, confidence, and swagger."}</p>
            </div>
            <div className="bg-[#1a1f2e] dark:bg-[#0f1219] border border-white/10 rounded-2xl p-6 sm:p-8">
              <div className="w-12 h-12 bg-[#2d2a1f] border border-[#c9a227]/30 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-5 h-5 text-[#c9a227]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="font-dm-serif text-xl text-[#c9a227] mb-2">{aboutData?.value4Title || "Integrity"}</h4>
              <p className="text-white/60 leading-relaxed">{aboutData?.value4Description || "Qualified and passionate coaches who are committed to guiding players at every development stage."}</p>
            </div>
          </div>
        </div>
      </section>
