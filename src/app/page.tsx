        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all hover:shadow-2xl hover:shadow-yellow-500/10 h-full flex flex-col">
              ...
              <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-2">
                  <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-1 rounded">OPTION A</span>
                </div>
            ...
            <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all hover:shadow-2xl hover:shadow-yellow-500/10 h-full flex flex-col">
              ...
              <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-1 rounded">OPTION B</span>
          ...
          <Link href="/design-c" className="group block h-full">
            <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-yellow-500/50 transition-all hover:shadow-2xl hover:shadow-yellow-500/10 h-full flex flex-col">
              ...
              <div className="p-4 sm:p-5 lg:p-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-2">
                  <span className="bg-yellow-500/20 text-yellow-400 text-xs px-2 py-1 rounded">OPTION C</span>
                </div>
